...
public class main {
    ...
    private static final List<Championship> championships  = new ArrayList<>(Arrays.asList(
    ...
    private static void displayChampionships(){
        ...
        for(int i = 0; i < championships.size(); i++){
            System.out.println(championships.get(i));
        }
        System.out.println("\n");
    }
    ...
    private static final List<Team> teams = new ArrayList<>(Arrays.asList(
